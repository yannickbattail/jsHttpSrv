...
function StatsInfo() {
    ...
    this.print = function(cssClass) {
        ...
        http.print('    <td>' + myRound(this.price1litre, 1000) + " EUR"
                + ((this.isCHF) ? (' <span title="taux: ' + this.rate + '">(' + this.priceRaw + "CHF)</span>") : ("")) + '</td>');
...
http.print('    <tr><th><label for="dist"  >Compteur</label> </th><td><input type="text"     id="dist"   name="dist"   value="'
        + Math.round(current.distTotal + avg.distDiff) + '"  /> </td></tr>');
http.print('    <tr><th><label for="liters">Litres</label>   </th><td><input type="text"     id="liters" name="liters" value="' + myRound00(avg.liters)
        + '"      /> </td></tr>');
http.print('    <tr><th><label for="price" >Prix/L</label>   </th><td><input type="text"     id="price"  name="price"  value="' + myRound00(avg.price1litre)
        + '" /> </td></tr>');
http
        .print('    <tr><th><label for="isCHF" >en CHF</label>   </th><td><input type="checkbox" id="isCHF"  name="isCHF"  value="1"                      /> </td></tr>');
http
