    ...
    function handleResponseBasic(request, response) {
        ...
        if (file.exists() && file.isFile()) {
            ...
            for ( var fIndex in fileList) {
                ...
                if (curFile.isFile()) {
                    html += '<tr><td class="file"><a href="./' + curFile.getName() + '" >' + curFile.getName() + '</a></td><td>'
                            + humanReadableByteCount(curFile.length(), false) + '</td></tr>';
                } else if (curFile.isDirectory()) {
                    html += '<tr><td class="dir"><a  href="./' + curFile.getName() + '/">' + curFile.getName() + '/</a></td><td>'
                            + humanReadableByteCount(curFile.length(), false) + '</td></tr>';
                }
            }
